...
namespace insitu
{
	...
	public sealed class Telemetry
	{
		...
		public void Save(string path, Json.Object info) => Save(path, Blocks, info, Types, StringCache);

		public static bool Save(string path, array<telemetry.Block> blocks, Json.Object info, array<TypeInfo> types, array<string> string_cache)
		{
			if (blocks.length < 1)
				return false;
