...
namespace insitu
{
	public static partial class Vicon
	{
		...
		public struct Marker
		{
			...
			/// </summary>
			public static bool Read(telemetry.Object value, array<string> string_cache, double4x4 position_transform, out Marker marker)
			{
				marker = default;
				...
				reader = reader.read(out marker.valid);
