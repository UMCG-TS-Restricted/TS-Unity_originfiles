...
namespace insitu
{
	...
	public struct double4x4
	{
		...
		/// <summary>
		///		Translation value of <paramref name="l"/>
		/// </summary>
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static double3 position(double4x4 l) => new double3 { x = l.m03, y = l.m13, z = l.m23 };

		/// <summary>
		///		Rotation value of <paramref name="l"/>
		/// </summary>
		public static double4 rotation(double4x4 l)
		{
